# Generated by Django 3.2.6 on 2021-08-06 07:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.PositiveSmallIntegerField(verbose_name='Описание')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='Описание')),
                ('poster', models.ImageField(upload_to='movie/', verbose_name='Аватар')),
                ('year', models.PositiveSmallIntegerField(default='2021', verbose_name='Дата выхода')),
                ('country', models.CharField(max_length=100, verbose_name='Страна')),
                ('world_premier', models.DateField(default=datetime.date(2021, 8, 6), verbose_name='Премьера в мире')),
                ...
                ('fees_in_world', models.PositiveIntegerField(default=0, help_text='Указать сумму в долларах', verbose_name='Сборы в мировом прокате')),
